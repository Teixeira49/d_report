...
final List<String> genreType = <String>[
  "Male",
  "Female",
  //"Other"
];

final List<String> genreTypeFull = <String>[
  "Hombre",
  "Mujer",
  "Otros",
  'Todos'
...
final Map<String, String> genreTypeFullMeta = {
  'Male': "Hombre",
  'Female': "Mujer",
  'Other': "Otros",
  '': 'Todos'
...
final List<String> entryAreaType = <String>[
  "Emergency",
  "Hospitalization",
  "Surgery"
];

final Map<String, String> entryAreaTypeMeta = {
  "Emergency": 'Emergencia',
  "Hospitalization": 'Hospitalizacion',
  "Surgery": 'Cirugia'
};

final List<String> endCaseType = [
  'Recuperado',
  'Fallecido',
  'Referido',
  'Retirado'
...
final Map<String, String> endCaseTypeMeta = {
  'SURVIVE': 'Recuperado',
  'DEAD': 'Fallecido',
  'REFERRAL': 'Referido',
  'ESCAPED': 'Retirado'
...
final List<String> endCaseTypeFull = [
  'Recuperado',
  'Fallecido',
  'Referido',
  'Retirado',
...
final List<String> floorType = <String>[
  ...
  "5",
  "6"
]; // TODO Cambiar a que la lista se genere sola
...
final List<String> userType = <String>[
  "Doctor",
  "Resident",
  "Administrator"
]; // TODO Crear su propio archivo de constantes
