...
class MyLoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context){
    ...
    final repository = AuthRepositoryImpl(remoteDataSource: remoteDataSource, networkInfo: NetworkInfoImpl(network));
                              ...
                              child: Column(
                                  ...
                                  children:[
                                    ...
                                    Container(
                                        ...
                                        child: LoginButton(username: _emailController.text, password: _passwordController.text,)
                                    ),
                                    TextButton(
