  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
            create: (context) => _followReportCubit
      ...
      child: DefaultTabController(
        ...
        child: BlocBuilder<PatientDataCubit, PatientDataState>(
          ...
          return Scaffold(
            ...
            body: Column(
              children: [
                patientInfo(context, state, authUser, user, caseId, 3, size),
                const TabBar(
                  tabs: [
  ...
  if ((state is PatientDataInitial || state is PatientDataLoading) &&
    ...
    return Column(
      ...
      children: [
        ...
        Visibility(
          visible: state.patient.patBirthdayPlace != null &&
              state.patient.patBirthdayPlace!.isNotEmpty,
    ...
    return Column(
      ...
      children: [
        ...
        CustomCardPatientRow(
          ...
          widgetValue:
              'Modulo de ${entryAreaTypeMeta[state.caseReport.casEntryArea]!}',
          tileIcon: Icons.local_hospital,
        ),
        CustomCardPatientRow(
          widgetKey: "Origen de ingreso del paciente",
          widgetValue: methodOfEntryTypeMeta[
              state.caseReport.casMethodOfEntry.toString()]!,
